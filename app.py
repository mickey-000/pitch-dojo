...
- 25点: 「誰が・何を・どうする」の動作が明確。ツール名は不要
- 20点: 解決の方向性は伝わるが動作の描写がやや薄い
- 15点: やりたいことは伝わるが手段・方法が不明確
- 10点: 「リアルタイム共有」「見える化」などバズワードのみで動作説明なし
- 5点: 一般論
- 0点: 施策への言及なし

■ 根拠（引用: {step1_result.get('evidence_quote','なし')}）
- 25点: 固有名詞・数値を2種類以上、提案と自然につなげている
- 20点: 固有名詞・数値を1〜2つ使っているが結びつきがやや弱い
